...
WIN_APP_FLAGS := /X /GF /Wall /EHsc# /TP
ifdef DEBUG
...
CLANG_VERB_CFLAGS := -x c -Weverything -Wno-padded -Wno-cast-align -Wno-reserved-id-macro -Wno-extended-offsetof -Wno-covered-switch-default -Wno-documentation -Wno-assume -Wno-disabled-macro-expansion
CLANG_VERB_CXXFLAGS := -x c++ -Weverything -Wno-padded -Wno-old-style-cast -Wno-cast-align -Wno-reserved-id-macro -Wno-extended-offsetof -Wno-covered-switch-default -Wno-documentation -Wno-c++11-long-long -Wno-variadic-macros -Wno-assume -Wno-unused-member-function -Wno-disabled-macro-expansion
VERB_CXXFLAGS := $($(COMPILER_TYPE)_VERB_CXXFLAGS)
VERB_CFLAGS   := $($(COMPILER_TYPE)_VERB_CFLAGS)
#VERB_CFLAGS := $(VERB_CXXFLAGS)
#DEF_SHARED_LIBS += -lstdc++
ifndef DEF_CFLAGS
