...
#define PRODUCT_PATCH_NUM     $(PRODUCT_PATCH_NUM)
#define PRODUCT_VERSION       "$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_PATCH_NUM)"
...
#define PRODUCT_BUILD_VERSION "$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_PATCH_NUM).$$1"
#endif
endef
